...
un virtualenv pulito. È autonomo e non richiede GitHub Actions; il workflow
Verify esegue lo stesso gate sulle pull request e sui push a main. Su sistemi
non Windows si può eseguire direttamente:
